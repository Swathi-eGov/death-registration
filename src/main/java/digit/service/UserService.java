...
//                application.setId(upsertUser(user, request.getRequestInfo()));
...
//        String accountId = application.getId();
...
//            throw new CustomException("INVALID_ACCOUNTID","No user exist for the given accountId");
//
//        else application.setId(userDetailResponse.getUser().get(0).getUuid());
